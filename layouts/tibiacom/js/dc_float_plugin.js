(function(){
    var load_float_dc = function($){
        var defaults = {
                ...
                //show_facepile:'true',
                //tabs:'timeline',
                href:'https://discordapp.com/invite/3NxYnyV?utm_source=Discord%20Widget&amp;utm_medium=Connect'
            },
            cfg = $("#float_dc").data(),
            iframe = 'https://discordapp.com/widget?id=528117503952551936&theme=dark',
            params = [],
        ...
        $("body").append(
            ['<div id="float_dc_plugin" style="visibility:hidden">',
                '<img src="' + png + '" style="cursor:pointer;position:absolute;margin-left:-40px;margin-top:365px;" border=0 />',
