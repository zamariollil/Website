...
<div id="PremiumBoxBg2" style="background-image:url(<?php echo $layout_name; ?>/images/global/themeboxes/premium/coins_exp.png);"></div>
<div id="PremiumBoxOverlay2" style="background-image:url(<?php echo $layout_name; ?>/images/global/themeboxes/premium/type_overlay.png);"><p id="PremiumBoxOverlayText2">Use XP Boosts!</p></div>
