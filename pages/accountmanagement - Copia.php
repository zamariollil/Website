...
if (!$logged)
    ...
    if ($action == "") {
        ...
        $main_content .= '
														...
														<div>20% XP a mais em ser Premium Account</div></div>
														...
														<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
															<tr>
																<td>
																	<b>' . $choiceCats['name'] . '</b>
																	<div style="float:right;" >
																		<form action="?subtopic=accountmanagementt&action=services" method="post" style="padding:0px;margin:0px;" >
        ...
        if (!empty($ready_errors)) {
            ...
            if ($_REQUEST['active_service'] == "yes") {
                ...
                if ($getItemId['category'] >= 3) {
						if($getItemId['category'] == 6) {
						$add_service = $SQL->query("INSERT INTO `z_ots_comunication` (`name`, `type`, `action`, `param1`, `param2`, `param3`, `param4`, `param5`, `param6`, `param7`, `delete_it`) VALUES ('$player_name', 'login', 'give_premday', '', '', '', '', 'premday', '".addslashes($getItemId['offer_name'])."', '".$getItemId['id']."', '1')");
