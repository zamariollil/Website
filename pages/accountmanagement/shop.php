													...
													<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
																	...
																	$main_content .= '
																		<div class="ServiceID_Icon_Container" id="ServiceID_Icon_Container_'.$product['id'].'">
																			...
																			if ($product['category'] == 3) {
																				...
																				$main_content .= '
																					<div class="ServiceID_Icon_New" id="ServiceID_Icon_New_'.$product['id'].'" style="background-image:url('.$layout_name.'/images/shop/vip/'.str_replace(" ","_",$product['offer_name']).'.png); background-repeat:no-repeat; margin:5px 30px;" ></div>';
																			}
														...
														if($serviceCategoryId == 6)
																...
																if($serviceCategoryId == 9)
																	$itemName = "Wands and Rods";
																if($serviceCategoryId == 10)
																	$itemName = "Weapons";
																if($serviceCategoryId == 11)
																	$itemName = "Boots";
																if($serviceCategoryId == 12)
																	$itemName = "Helmet";
																if($serviceCategoryId == 13)
																	$itemName = "Shield";
