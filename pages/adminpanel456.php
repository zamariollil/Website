													...
													<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
														...
														if($getCountServices > 0) {
															...
															foreach($get_Services as $service) {
																...
																elseif ($get_historyService['category'] == 7)
																	$pathToService = "images/shop/items/".$get_historyService['itemid'].".gif";
																	elseif ($get_historyService['category'] == 8)
																	$pathToService = "images/shop/items/".$get_historyService['itemid'].".gif";
																	elseif ($get_historyService['category'] == 9)
																	$pathToService = "images/shop/items/".$get_historyService['itemid'].".gif";
																	elseif ($get_historyService['category'] == 10)
																	$pathToService = "images/shop/items/".$get_historyService['itemid'].".gif";
																	elseif ($get_historyService['category'] == 11)
																	$pathToService = "images/shop/items/".$get_historyService['itemid'].".gif";
																	elseif ($get_historyService['category'] == 12)
																	$pathToService = "images/shop/items/".$get_historyService['itemid'].".gif";
																	elseif ($get_historyService['category'] == 13)
												...
												<td>
													...
													<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
														<div class="TableContentContainer" >
															...
															$getExtraServices = $SQL->query("SELECT * FROM `z_shop_offer` WHERE `category` = '7' ORDER BY `offer_name` ASC")->fetchAll();
															$offer_number = 0;
															foreach($getExtraServices as $g_extra) {
																if($g_extra['offer_type'] != "changesex")
																$main_content .= '
												...
												<tr>
													<td>
														...
														<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
															...
															$get_Shield = $SQL->query("SELECT * FROM `z_shop_offer` WHERE `category` = '$serviceId' ORDER BY `offer_date` DESC")->fetchAll();
															$shield_number = 0;
															foreach($get_Shield as $g_shield) {
																$bgcolor = (($shield_number++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
																$main_content .= '
																	<tr style="background-color:'.$bgcolor.';" >
																		<td width="32px">
																		<img src="'.$layout_name.'/images/shop/items/'.strtolower($g_shield['itemid']).'.gif"</td>
																		<td>'.$g_shield['itemid'].'</td>
																		<td>'.$g_shield['offer_name'].'</td>
																		<td>'.((!empty($g_shield['offer_description'])) ? $g_shield['offer_description'] : 'No description').'</td>
																		<td>'.$g_shield['coins'].' Coins</td>																		
																		<td width="135px">
																			<form id="delItem" method="post" style="padding:0px;margin:0px;" >
																				<div class="BigButton" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton_red.gif)" >
																					<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton_red_over.gif);" ></div>
																						<input type="hidden" class="delItemId" name="delItemId" value="'.$g_shield['id'].'">
																						<input class="ButtonText delItem" type="image" name="Delete" alt="Delete" src="'.$layout_name.'/images/global/buttons/_sbutton_delete.gif" >
																					</div>
																				</div>
																			</form>
												...
												<tr>
													<td>
														...
														<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);" >
															...
															$get_Armor = $SQL->query("SELECT * FROM `z_shop_offer` WHERE `category` = '$serviceId' ORDER BY `offer_date` DESC")->fetchAll();
															$item_number = 0;
															foreach($get_Armor as $g_Armo) {
																$bgcolor = (($item_number++ % 2 == 1) ?  $config['site']['darkborder'] : $config['site']['lightborder']);
																$main_content .= '
																	<tr style="background-color:'.$bgcolor.';" >
																		<td width="32px">
																		<img src="'.$layout_name.'/images/shop/items/'.strtolower($g_Armo['itemid']).'.gif"</td>
																		<td>'.$g_item['itemid'].'</td>
																		<td>'.$g_item['offer_name'].'</td>
																		<td>'.((!empty($g_Armo['offer_description'])) ? $g_Armo['offer_description'] : 'No description').'</td>
																		<td>'.$g_item['coins'].' Coins</td>																		
																		<td width="135px">
																			<form id="delItem" method="post" style="padding:0px;margin:0px;" >
																				<div class="BigButton" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton_red.gif)" >
																					<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url('.$layout_name.'/images/global/buttons/sbutton_red_over.gif);" ></div>
																						<input type="hidden" class="delItemId" name="delItemId" value="'.$g_Armo['id'].'">
																						<input class="ButtonText delItem" type="image" name="Delete" alt="Delete" src="'.$layout_name.'/images/global/buttons/_sbutton_delete.gif" >
																					</div>
																				</div>
																			</form>
					...
					<center>
						<table>
							<tbody>
								<tr>
									<td><img src="'.$layout_name.'/images/global/content/headline-bracer-left.gif"></td>
									<td style="text-align:center;vertical-align:middle;horizontal-align:center;font-size:17px;font-weight:bold;">Manage your Items Legs Sales</td>
									<td><img src="'.$layout_name.'/images/global/content/headline-bracer-right.gif"></td>
								</tr>
							</tbody>
						</table>
