...
//<TR><TD style="width: 20%">Managing Director:</TD><TD>Roberto</TD></TR>
...
$main_content .= '<tr bgcolor="' . $bgcolor . '"><td><b>ADM OTServ</b></td><td>Administrator</td></tr>';
$bgcolor = (($i++ % 2 == 1) ? $config['site']['darkborder'] : $config['site']['lightborder']);
$main_content .= '<tr bgcolor="' . $bgcolor . '"><td><b>Dev otserv</b></td><td>Developer</td></tr>';
$bgcolor = (($i++ % 2 == 1) ? $config['site']['darkborder'] : $config['site']['lightborder']);
$main_content .= '<tr bgcolor="' . $bgcolor . '"><td ><b>Dev otserv</b></td><td>Developer</td></tr>';
foreach ($list as $i => $supporter) {
	//    var_dump($supporter);
	if (!in_array($supporter['id'], $ignore)) {
		$bgcolor = (($i++ % 2 == 1) ? $config['site']['darkborder'] : $config['site']['lightborder']);
		$main_content .= '<tr bgcolor="' . $bgcolor . '"><td><b>' . htmlspecialchars($supporter['name']) . '</b></td><td>' . htmlspecialchars(Website::getGroupName($supporter['group_id'])) . '</td></tr>';
	}
}
$main_content .= $make_table_footer();
$main_content .= "</div>";
...
$main_content .= "<table border=0 cellspacing=1 cellpadding=4 width=100%>
	<td class=\"white\" colspan=\"3\" align=\"left\" bgcolor=\"#505050\"><b>RadBR Membres</b></td>
